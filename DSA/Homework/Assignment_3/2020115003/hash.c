...
//char str3[100001];
int isGoodString(char main_str[100001], char sec_str[100001], long int len_main, long int len_sec)  //O(n) time
{
    // if (len_main == 0 || len_sec == 0)
    //     return 0;
